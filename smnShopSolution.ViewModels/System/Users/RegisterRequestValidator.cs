...
namespace smnShopSolution.ViewModels.System.Users
{
    public class RegisterRequestValidator : AbstractValidator<RegisterRequest>
    {
        public RegisterRequestValidator() // constructor
        {
            ...
            RuleFor(x => x.Password).NotEmpty().WithMessage("Password is requires")
